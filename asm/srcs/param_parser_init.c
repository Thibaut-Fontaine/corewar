...
/*   Updated: 2017/07/10 19:32:45 by jgagnot          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_param_parser	*param_parser_init(void)
{
	...
	tab[9] = (t_param_parser){10, "ldi", 3, {7, 6, 1}, 2, 2};
	tab[10] = (t_param_parser){11, "sti", 3, {1, 7, 6}, 2, 2};
	tab[11] = (t_param_parser){12, "fork", 1, {2, 0, 0}, 1, 2};
	tab[12] = (t_param_parser){13, "lld", 2, {6, 1, 0}, 2, 4};
	tab[13] = (t_param_parser){14, "lldi", 3, {7, 6, 1}, 2, 2};
